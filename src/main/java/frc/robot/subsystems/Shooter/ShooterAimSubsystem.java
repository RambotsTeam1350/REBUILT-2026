...
public class ShooterAimSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        // ^ make sure all of these numbers are being updated frequently so the turret
        // is always aiming at the right place
    ...
    public Command AngleAdjust() {
        return Commands.sequence(
                Commands.runOnce(() -> motor
                        .setControl(new MotionMagicVoltage(degreesToEncoderUnits(getAngleAdjusterTheta())))));
    }
